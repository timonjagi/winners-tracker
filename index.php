      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                    class="glyphicon glyphicon-user"></span><?php echo ucwordsEx($username, '.'); ?><b class="caret"></b></a>
        ...
        <div class="container">
            ...
            <div class="tab-content">
                ...
                <div class="col-md-12 tab-pane active" id="addwinner" style="display:" >
                    ...
                    <form class="form form-inline" id="addwinner" action="index.php" method="post" role="form">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 well well-sm">
                            ...
                            <div class ="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input class="form-control" placeholder="Presenter" name="presenter" type="text" />
                                </div>
                            </div>
